...
namespace App\Http\Controllers\OrderLineControllers;

use App\Classes\Constant;
use App\EntityConstraints\OrderLineConstraint;
...
class OrderLineStore extends Controller
{
    public function store(Request $request): View|RedirectResponse|Redirector|Response|JsonResponse
    {
        ...
        $model = OrderLine::create($storingData);
